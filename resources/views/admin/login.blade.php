...
<body>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					<div class="icons">
						<a href="{{asset('admin')}}/index.html"><i class="halflings-icon home"></i></a>
						<a href="{{asset('admin')}}/#"><i class="halflings-icon cog"></i></a>
					</div>
...
@endif
	...
	@csrf
					...
					<p>
						No problem, <a href="{{asset('admin')}}/#">click here</a> to get a new password.
					</p>	
				</div><!--/span-->
			</div><!--/row-->
